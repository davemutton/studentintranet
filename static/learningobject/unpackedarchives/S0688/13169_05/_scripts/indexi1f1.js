...
function iefixNindexi1f1() {
   ...
   document.write('        <param name="movie" value="unit_1e.swf">\n')
   document.write('        <param name="quality" value="high">\n')
   document.write('        <embed src="unit_1e.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100%" height="100%"></embed></object>\n')
